...
export const PROJECTS:Project[] = [
  ...
  { id: 16, 
    ...
    component: null,
    demo: '',
    demoLink: 'http://www.flitfire.com/tech/code/vizalgo.html',
  ...
  { id: 17, 
    ...
    img: 'images/linkedListTrain.jpg', 
    componentName: '',
    component: null,
    demo: '',
    demoLink: 'demoLink',
  ...
  { id: 19, 
    ...
    componentName: '',
    component: null,
    demo: '<p><em>Source code coming soon...</em></p>',
    demoLink: '',
    codeRepo: '',
    isFavorite: false },
  { id: 20, 
    ...
    description: "<p>Details coming soon...</p>", 
    img: 'images/trashbasketball.jpg', 
    componentName: '',
    component: null,
    demo: '<p><em>Details coming soon...</em></p>',
    demoLink: '',
  ...
  { id: 22,
    ...
    <div id='charging_hdr'>\
    <h3>Charging</h3>\
    <p>Not surprisingly, you need to charge both vacuums completely before their first use.  (Actually, our Roomba arrived with a bit of residual charge so we were able to satisfy our initial curiosity and run it for a minute or two before having to charge it.)</p>\
    <p>You can charge Roomba in one of two ways.  Plug the charging station's power cord into a nearby outlet, set the Roomba over the station's contact strip and make sure the color of the vacuum's LED changes to indicate that it's charging.  Alternatively, you can skip the charging station and just plug the power cord directly into the Roomba.  Our Roomba was fully charged within two hours.</p>\
    ...
    <iframe src='http://www.youtube.com/embed/R85MLQ6o9dg' frameborder='0' width='420' height='315' ></iframe>\
    <p>Occasionally Roomba also has trouble picking up heavier debris or cat hair that's stuck to the carpeting.  On the whole, though, both Roomba and Neato pick up debris effectively, especially if you judge by the amount of dirt that fills their bins after a cleaning.  Roomba's counter-rotating brushes and multiple passes over the same area undoubtedly help it clean well but the latter also means that Roomba always takes longer to clean a room than Neato.</p>\
    <p>When going full speed, Roomba is still relatively quiet (similar to a box fan running on low-to-medium speed).  We found the Neato to be a little bit louder than Roomba, perhaps due to stronger suction, and that it ran out of charge sooner than the Roomba.  (Neato ran for 30 minutes and Roomba for 90 minutes before their batteries needed recharging.)  How far either vacuum gets on a single charge will vary based on the number of obstacles it has to work around, the thickness of the carpeting, etc.  When it did run low on charge, Neato did not have any trouble returning to its charging station and automatically docking.  After recharging, it auto-powered back up and completed cleaning, picking up where it left off.</p>\
    <p>Note: Neato struggled somewhat when working on thicker carpeting (1/2' pile) with the pet brush installed.  Its motor worked very hard, causing it to use up its charge faster, and it began clicking.  We replaced the pet brush with the standard brush, after which the clicking stopped and the motor revved less.</p>\
    <p>Roomba will also find its way back to its charging station once it has finished vacuuming or if it begins to run low on charge but unlike the Neato, which keeps a map to its base station in memory, our Roomba is only able to return to its home base when it can detect a clear path to it.  When its battery needs recharging, Roomba's LED turns orange and the 'Dock' button starts flashing green.  If, at that point, it is too far away to find its home, we either have to pick it up and carry it back or we herd it toward to a direct path using the Virtual Wall units.  Neither way is ideal.</p>\
    <p>We initially ran both vacuums in a room that contained three counter stools and a small table with two chairs so there were lots of legs to navigate. Roomba had a very difficult time with the chairs and stools, ping-ponging from one leg to another, and was not able to clean around them efficiently.  After removing the chairs and stools, Roomba was able to navigate just the table legs well enough.</p>\
    <p>Our Neato was able to navigate around the stools and chairs more efficiently but like the Roomba, it works much better when they are removed.  When necessary, Neato will automatically lift its backend up to help it maneuver out of tight areas.  However, Neato did get stuck a couple of times where the Roomba did not, notably 1) under a bookcase because Neato has a raised 'scanning eye' on top that makes it taller than the Roomba and 2) under an air vent cover that Neato pushed up against a table leg, then got wedged under.  Once stuck, Neato displayed a message to let us know it needed help getting unstuck.</p> \
    <div id='scheduling_hdr'>\
    <h4>...With Scheduling</h4>\
    </div>\
    <p>Setting a scheduled cleaning time on either vacuum is easy  and both allow you to schedule one cleaning per day, seven days a week and will repeat the scheduled time(s) unless you remove it (them). Roomba lets us schedule down to the minute while Neato only schedules on the quarter-hour.</p>\
    <p>I scheduled a test run on each and at its schedule time, each vacuum powered up by itself and began cleaning.  Both vacuums ran low on battery power before finishing the scheduled cleaning but only Neato was able to return to its base station to recharge without assistance.   Once recharged, it powered back up and completed the job.  I don't know about Roomba -- it ran so long on its first charge that I had to leave before it completed recharging, and because I didn't want it running while I was not home to monitor it, I cancelled the remainder of the scheduled job.</p> \
    <p>The following two videos show Roomba and Neato performing a scheduled clean over a small, restricted area (about 12' x 8').</p> \
    <div class='video'><dl id='attachment_107' class='wp-caption aligncenter' style='width: 430px;'><dt class='wp-caption-dt'><iframe src='http://www.youtube.com/embed/yaNTr5s2oyY' frameborder='0' width='420' height='315'></iframe></dt><dd class='wp-caption-dd'>Roomba's actual run time was 29 minutes. Video condensed to 2:01 minutes.</dd></dl></div>\
    <div class='video'><dl id='attachment_108' class='wp-caption aligncenter' style='width: 430px;'><dt class='wp-caption-dt'><iframe src='http://www.youtube.com/embed/p13v9YVXdOw' frameborder='0' width='420' height='315'></iframe></dt><dd class='wp-caption-dd'>Neato's actual run time was 9:30 minutes. Video condensed to 1:03 minutes.</dd></dl></div>\
    <div id='spot_hdr'>\
    <h4>...On the Spot</h4>\
    </div>\
    <p>While both Neato and Roomba provide a spot cleaning mode, they work differently.</p>\
    <p>Roomba spot cleans in a circle around its starting point, spiraling out in overlapping but increasingly larger circles until it reaches a diameter of about 3.5' feet.  Then it begins to decrease the size of its circles, spiraling inward back to original starting position, and powers down.</p>\
    <div class='video'><dl id='attachment_107' class='wp-caption aligncenter' style='width: 430px;'><dt class='wp-caption-dt'><iframe src='http://www.youtube.com/embed/jSFPpWbZCUc' frameborder='0' width='420' height='315'></iframe></dt><dd class='wp-caption-dd'>In a spot clean test with one ounce of barley grains, Roomba left behind quite a few seeds, in part because its fast-rotating edge brush scattered them. (Video shown at 2.35x original speed.)</dd></dl></div>\
    ...
    <tr>\
    <th width='26%'></th>\
    <th width='37%'>iRobot Roomba 595 Pet Vacuum</th>\
    <th width='37%'>Neato XV-21 Pet and Allergy Vacuum</th>\
    </tr>\
    <tr>\
    <td>Price</td>\
    <td valign='top' width='37%'>Costco: $299</td>\
    <td>Best Buy: $380  (minus our  Best Buy Silver Rewards member discount)</td>\
    </tr>\
    <tr>\
    <td>Packaging</td>\
    <td>thin bubble wrap interior packaging, accessories spread throughout box</td>\
    <td>innovative interior packaging -- well protected, formed, sturdy bubble strips.\
    all accessories come in a single box</td>\
    </tr>\
    <tr>\
    <td>Size &amp; Shape</td>\
    <td>circular with 12' diameter</td>\
    <td>filled  12'x 12.75' U shape</td>\
    </tr>\
    <tr>\
    <td>Comes with Quick Start guide?</td>\
    <td>yes</td>\
    <td>yes</td>\
    </tr>\
    <tr>\
    <td>Charging mechanism</td>\
    <td>vacuum placed over charging contacts on base station or power cord plugged directly into vacuum.</td>\
    <td>vacuum positioned against base station so that two contact bumper strips are depressed.</td>\
    </tr>\
    <tr>\
    <td>Interface</td>\
    <td>Buttons, LED lights, digital clock display, and sounds.</td>\
    <td>LCD panel (written messages in language of choice), indicator light, buttons and sounds</td>\
    </tr>\
    <tr>\
    <td>Initial charge time</td>\
    <td>2 - 3 hours</td>\
    <td>2 - 3 hours</td>\
    </tr>\
    <tr>\
    <td>Cleaning mechanism</td>\
    <td>Edge-cleaning brush pulls dirt under unit where two counter-rotating brushes and suction pick up dirt</td> \
    <td>Wide brush and strong suction pick up dirt</td>\
    </tr>\
    <tr>\
    <td>Cleaning modes</td>\
    <td>General, spot, scheduled</td>\
    <td>General, spot, scheduled</td>\
    </tr>\
    <tr>\
    <td>Cleaning pattern</td>\
    <td><em>Spot:</em> spirals out to 3.5' diameter and back.\
    <em>General/Scheduled: </em>criss-crossing passes, wall following, spins around dirtier spots; makes multiple passes over same area; doesn't recognize change from one room to next so moves randomly among rooms if Virtual Wall units are not used.</td>\
    <td><em>Spot:</em> covers 6' x 4' rectangle\
    <em>General/Scheduled:</em> maps exterior of a room then back and forth within the mapped boundaries; single pass over entire area; detects doorways so does one room completely before moving on to next.</td>\
    </tr>\
    <tr>\
    <td>Noise level</td>\
    <td>Relatively quiet</td>\
    <td>A little louder than Roomba but not so loud you can't talk while it's vacuuming the room you are in</td>\
    </tr>\
    <tr>\
    <td>Restricting areas</td>\
    <td>uses Virtual Wall units that emit an invisible, cone-shaped  beam that Roomba will not cross</td>\
    <td>uses magnetic strips placed on the floor that Neato will not cross</td>\
    </tr>\
    <tr>\
    <td>Recommended Maintenance</td>\
    <td>clean dirt bin and filter each cleaning cycle; clean brushes as needed</td>\
    <td>clean dirt bin, filter and drop sensors each cleaning cycle; clean brushes as needed</td>\
    </tr>\
    <tr>\
    <td>Accessories</td>\
    <td>three replacement filters, two Virtual Wall units &amp; charging station come with vacuum.  Also remote control and Virtual Wall Halo may be purchased.</td>\
    <td>charging station, standard brush &amp; 13' boundary marker comes with vacuum.  May purchase additional boundary marker.</td>\
    </tr>\
    <tr>\
    ...
    <tr>\
    <td>Detects drop offs</td>\
    <td>yes</td>\
    <td>yes</td>\
    </tr>\
    <tr>\
    <td>Anti-tangle system</td>\
    <td>yes</td>\
    <td>no</td>\
    </tr>\
    <tr>\
    <td>Navigating obstacles and tight areas</td>\
    <td>Edge detection; Rotates and retries forward movement until successful</td>\
    <td>Edge detection; Laser mapping; Lifts backend up to maneuver around obstacles and out of tight spots</td>\
    </tr>\
    </tbody>\
    </table>",
